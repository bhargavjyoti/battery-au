...
import { Facebook, Linkedin, Instagram, ArrowRight, Clock } from "lucide-react";
import { BatteryIcon, MapPinIcon, PhoneIcon, MailIcon, ZapIcon } from "@animateicons/react/lucide";
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-gray-400">
                  <MapPinIcon className="w-5 h-5 text-blue-400 mt-0.5 shrink-0" />
                  <div>
